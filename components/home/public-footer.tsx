...
export function PublicFooter() {
  ...
  const sections = [
    {
      ...
      items: [
        { label: t.footer.allTeachers, href: "#" },
        { label: t.footer.forum, href: "#" },
        { label: t.footer.blog, href: "#" },
        { label: t.footer.myJobs, href: "#" },
        { label: t.footer.joiningTeachUp, href: "#" },
        { label: t.footer.allGuides, href: "#" },
      ],
    },
    {
      title: t.footer.professions,
      items: [
        { label: t.footer.development, href: "#" },
        { label: t.footer.design, href: "#" },
        { label: t.footer.informationSciences, href: "#" },
        { label: t.footer.marketing, href: "#" },
        { label: t.footer.productManagement, href: "#" },
      ],
    },
    {
      title: t.footer.more,
  ...
  return (
    <footer className="bg-linear-to-b from-white to-[#EEF3FD]">
      <div style={{ padding: "50px 40px 24px" }}>
        ...
        <div style={{ marginTop: 16 }} className="flex items-center justify-end gap-3">
          {[
            <path key="yt" d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />,
            ...
            <Link key={i} href="#" className="flex h-5 w-5 items-center justify-center text-primary-dark transition-colors hover:text-foreground">
