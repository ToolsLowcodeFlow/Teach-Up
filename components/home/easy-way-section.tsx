...
const features = [
  {
    ...
    title: "Smart agent for finding guides",
    description: "This is a dummy paragraph text that aims to fill a space in the website design and demonstrate how.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" stroke="white" strokeWidth="2" strokeLinecap="round"/><path d="M22 4 12 14.01l-3-3" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
    ),
    title: "Jobs that receive truly relevant applications",
    description: "This is a dummy paragraph text that aims to fill a space in the website design and demonstrate how.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M20 7H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z" stroke="white" strokeWidth="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" stroke="white" strokeWidth="2"/></svg>
    ),
    title: "Targeted job advertising for the target audience",
    description: "This is a dummy paragraph text that aims to fill a space in the website design and demonstrate how.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="11" cy="11" r="6" stroke="white" strokeWidth="2"/><path d="m21 21-4.35-4.35" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
    ),
    title: "The largest database of education professionals in Israel",
    description: "This is a dummy paragraph text that aims to fill a space in the website design and demonstrate how.",
  },
];
    ...
    <section style={{ padding: "60px 40px" }} className="flex flex-col items-center bg-[#F7F9FC]">
      ...
      <div style={{ marginBottom: 20 }} className="text-center">
        <h2 className="max-w-2xl text-4xl leading-tight text-foreground">
          The easy way to find education and teaching professionals.
        </h2>
      </div>
