...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-linear-to-b from-[#D6E4FF] via-primary-light to-[#F7F9FC]">
      {/* Background grid — white boxes like Figma */}
        ...
        <div className="w-full max-w-2xl">
          ...
          <div style={{ padding: "8px" }} className="mx-auto flex items-center gap-2 rounded-2xl bg-white shadow-lg">
            ...
            <button
              ...
              className="flex shrink-0 items-center gap-2 rounded-xl bg-primary text-sm text-white transition-colors hover:bg-primary-dark"
            >
            ...
            {/* Area dropdown */}
            <button className="flex flex-1 items-center justify-between px-3 py-2 text-sm text-foreground">
              <span>{t.home.area}</span>
            ...
            {/* Role dropdown */}
            <button className="flex flex-1 items-center justify-between px-4 py-2 text-sm text-foreground">
