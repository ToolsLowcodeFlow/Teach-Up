    ...
    <footer className="mt-auto overflow-hidden bg-linear-to-b from-white to-[#EEF3FD]">
      <div style={{ padding: "80px 40px 32px" }}>
        ...
        <div className="flex flex-wrap items-start gap-10">
          {/* Link columns - take remaining space */}
          <div className="flex min-w-0 flex-1 flex-wrap gap-10 lg:gap-16">
          ...
          {/* Logo + description - shrinks on small screens */}
          <div className="flex w-full min-w-0 flex-col items-end gap-6 lg:w-auto lg:max-w-sm">
            ...
            <p className="text-end text-sm leading-relaxed text-muted-foreground lg:text-base">
        ...
        <div className="mt-6 flex items-center gap-2.5">
          <Link href="#" aria-label="YouTube" className="flex h-6 w-6 items-center justify-center text-muted-foreground transition-colors hover:text-foreground">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" fill="currentColor"/>
            </svg>
          </Link>
          <Link href="#" aria-label="Instagram" className="flex h-6 w-6 items-center justify-center text-muted-foreground transition-colors hover:text-foreground">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <Link href="#" aria-label="TikTok" className="flex h-6 w-6 items-center justify-center text-muted-foreground transition-colors hover:text-foreground">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <Link href="#" aria-label="Facebook" className="flex h-6 w-6 items-center justify-center text-muted-foreground transition-colors hover:text-foreground">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
