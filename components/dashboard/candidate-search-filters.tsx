    ...
    <aside style={{ padding: 24 }} className="w-full rounded-[20px] bg-linear-to-b from-white to-white/0 lg:max-w-87.5">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex w-full flex-col gap-5">
          ...
          <DropdownSelect label={t.candidateSearch.mobileWithCar} options={[t.candidateSearch.option1, t.candidateSearch.option2, t.candidateSearch.option3]} />
          ...
          <DropdownSelect label={t.candidateSearch.teachingPreferences} options={[t.candidateSearch.option1, t.candidateSearch.option2, t.candidateSearch.option3]} />
          <DropdownSelect label={t.candidateSearch.dealerType} options={[t.candidateSearch.option1, t.candidateSearch.option2, t.candidateSearch.option3]} />
        </div>
