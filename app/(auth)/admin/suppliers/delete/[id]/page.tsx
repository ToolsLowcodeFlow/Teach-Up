  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Illustration — reusing success illustration with red tint */}
        ...
        <p className="text-center text-sm leading-[1.4] text-muted-foreground" style={{ marginBottom: 24 }}>
          Are you sure you want to delete Tel Aviv University?
        </p>
