...
import { ChevronDown, Heart, Bell, MessageSquare, Globe, Phone } from "lucide-react";
...
export default function ContactPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#F7F9FC]" style={{ fontFamily: "'Abel', sans-serif" }}>
        ...
        <div className="mx-auto flex max-w-[1375px] items-center justify-between" style={{ padding: "12px 40px" }}>
          <div className="flex items-center gap-10">
            ...
            <nav className="flex items-center gap-8 text-base">
              ...
              <a className="relative cursor-pointer text-foreground">
                Contact us
                <span className="absolute bottom-[-8px] left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-primary" />
              </a>
            </nav>
          </div>
      ...
      {/* Content */}
      <div className="mx-auto flex w-full max-w-[1375px] flex-1 gap-12" style={{ padding: "40px 40px 60px" }}>
        {/* Left — Contact info */}
        <div className="flex flex-col" style={{ width: 480, gap: 24 }}>
          <h1 className="text-[36px] leading-[1.2] text-foreground">Contact us</h1>
          <p className="text-lg leading-[1.4] text-foreground">
            Do you have a question, request, or problem? You can leave your details here and we will get back to you as soon as possible.
          </p>
          <p className="text-sm text-muted-foreground">Feel free to contact us on any topic.</p>
        ...
        <div className="flex flex-1 flex-col rounded-2xl bg-white" style={{ padding: "32px 36px" }}>
          <div className="flex flex-col" style={{ gap: 20 }}>
            ...
            <button className="cursor-pointer self-end rounded-lg text-sm text-white" style={{ padding: "12px 32px", border: "none", backgroundImage: "linear-gradient(168deg, #4C96FF 12%, #1667DB 94%)" }}>
              sending
            </button>
          </div>
        </div>
